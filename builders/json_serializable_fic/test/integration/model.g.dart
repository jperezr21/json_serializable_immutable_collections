...
MyModel _$MyModelFromJson(Map<String, dynamic> json) => MyModel(
  ...
  builtMapString: Map<String, String>.from(
    json['builtMapString'] as Map,
  ).toIMap(),
  ...
  builtMap: (json['builtMap'] as Map<String, dynamic>)
      .map((k, e) => MapEntry(int.parse(k), e as String))
      .toIMap(),
  ...
  nullableSet: (json['nullableSet'] as List).map((e) => e as String?).toISet(),
