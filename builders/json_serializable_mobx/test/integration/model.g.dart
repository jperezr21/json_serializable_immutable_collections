...
MyModel _$MyModelFromJson(Map<String, dynamic> json) => MyModel(
  ...
  myNested: ObservableList<Nested>.of(
    (json['myNested'] as List).map(
      (e) => Nested.fromJson(e as Map<String, dynamic>),
    ),
  ),
  myNestedWithNulls: ObservableList<Nested?>.of(
    (json['myNestedWithNulls'] as List).map(
      (e) => e == null ? null : Nested.fromJson(e as Map<String, dynamic>),
    ),
  ),
  ...
  nullobservable: json['nullobservable'] != null
      ...
      : null,
  nestedSet: ObservableSet<Nested>.of(
    (json['nestedSet'] as List).map(
      (e) => Nested.fromJson(e as Map<String, dynamic>),
    ),
  ),
);
...
Map<String, dynamic> _$MyModelToJson(MyModel instance) => <String, dynamic>{
  ...
  'myNestedWithNulls': instance.myNestedWithNulls
      .map((e) => e?.toJson())
      .toList(),
  ...
  'builtMapNested': instance.builtMapNested.map(
  ...
  'nestedMapWithNulls': instance.nestedMapWithNulls.map(
